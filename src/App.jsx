    ...
    <div style={{padding:16, maxWidth:760, margin:"0 auto"}}>
      ...
      <div style={{padding:"12px 14px", background:"#04140a", borderRadius:8, border:"1px solid #4ade8055", marginBottom:14}}>
        ...
        <div style={{display:"flex", flexDirection:"column", gap:7}}>
          ...
          <div style={{display:"flex", gap:8, padding:"7px 9px", background:"#001018", borderRadius:5}}><span style={{color:"#4ade80", fontWeight:700}}>3.</span><span style={{fontSize:9, color:TEXT, lineHeight:1.45}}><b>Le mouvement va durer plusieurs sessions.</b> Tu entres pendant Londres, tu gardes ta position pendant New York (8h), puis la session asiatique (Tokyo + Sydney) prend le relais le soir sur tes paires — jamais deux devises de la même session, toujours une devise de Londres contre une devise d'Asie. Tu te places au début d'un flux qui passe de main en main, pas dans un coup d'une heure.</span></div>
