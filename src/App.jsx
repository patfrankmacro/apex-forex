      ...
      <div style={{padding:"12px 14px", background:"#0a1628", borderRadius:8, border:"1px solid #fbbf2444", marginBottom:14}}>
        ...
        <div style={{display:"flex", flexDirection:"column", gap:10}}>
          ...
          <div style={{padding:"8px 10px", background:"#001018", borderRadius:6, borderLeft:"3px solid #4ade80"}}>
            ...
            <div style={{fontSize:8, color:TEXT_DIM, lineHeight:1.7}}>Londres ferme, mais Tokyo et Sydney ouvrent. Le relais se fait naturellement — aucune banque n'appelle l'autre. Elles voient toutes le même chart et les mêmes fondamentaux :<br/><br/>
