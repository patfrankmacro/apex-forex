    ...
    <div style={{padding:16, maxWidth:760, margin:"0 auto"}}>
                ...
                return (
                  <div key={x.wpair} style={{ padding:"8px 10px", marginBottom:6, background:bg, border:bd, borderRadius:6 }}>
                    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:3 }}>
                      ...
                      <span style={{ fontSize:8, fontWeight:700, padding:"2px 6px", borderRadius:3, background:is3?(isBuy?"#00ff88":"#ff3b3b"):"#fbbf2433", color:is3?"#001a0d":"#fbbf24" }}>{is3?"🟢 3/4 — vérifie ④":"🟡 2/4"}</span>
                    </div>
                    <div style={{ fontSize:8, color:TEXT, lineHeight:1.6 }}>
                      <span style={{color:x.f1===true?"#4ade80":x.f1===false?"#f87171":"#64748b"}}>① Divergence {x.forceGap!=null?x.forceGap+"r "+(x.f1?"✓":"✗"):"– (colle MarketMilk)"}</span> · <span style={{color:"#4ade80"}}>② Retail {x.direction==="LONG"?"SHORT":"LONG"} {x.direction==="LONG"?x.rShort:x.rLong}% ✓</span> · <span style={{color:"#a78bfa"}}>③ LF: {x.sCur} {x.lfS>=0?"+":""}{x.lfS?.toLocaleString()} vs {x.wCur} {x.lfW>=0?"+":""}{x.lfW?.toLocaleString()} ✓</span> · <span style={{color:"#64748b"}}>④ Top5 – (colle MarketMilk)</span>
                    </div>
                    ...
                    {!is3 && <div style={{ fontSize:7.5, color:"#fbbf24", marginTop:3 }}>Retail + Leveraged Funds alignés. Colle MarketMilk + Analyse pour vérifier la divergence (①) ET que la paire est dans le Top 5 Gainers/Losers (④).</div>}
                  </div>
                );
              })}
            </div>
      ...
      <div style={{padding:"12px 14px", background:"#0d0a1a", borderRadius:8, border:"1px solid #818cf855", marginBottom:14}}>
        ...
        <div style={{marginBottom:10, padding:"10px 11px", background:"#0a1420", borderRadius:6, borderLeft:"3px solid #f59e0b"}}>
          ...
          <b style={{color:"#f59e0b"}}>Attention :</b> ce filtre confirme la DIRECTION à l'analyse (10h30-10h45), il ne dit pas d'entrer maintenant. Tu attends toujours le pullback au Golden Pocket pour entrer — jamais sur l'extension.</div>
        </div>
        ...
        <div style={{padding:"10px 11px", background:"#160a2e", borderRadius:6, border:"1px solid #818cf844"}}>
          ...
          Quand le flux temps réel (①), le carburant de la foule (②), le flux frais des fonds (③) et le mouvement réel du jour (④) pointent tous vers la même paire → tu n'es pas sur une illusion. Tu es sur un vrai courant institutionnel, confirmé sous quatre angles indépendants qui se compensent.</div>
        </div>
      </div>
      ...
      <div style={{padding:"12px 14px", background:"#04140a", borderRadius:8, border:"1px solid #4ade8055", marginBottom:14}}>
        ...
        <div style={{display:"flex", flexDirection:"column", gap:7}}>
          <div style={{display:"flex", gap:8, padding:"7px 9px", background:"#001018", borderRadius:5}}><span style={{color:"#4ade80", fontWeight:700}}>1.</span><span style={{fontSize:9, color:TEXT, lineHeight:1.45}}><b>Les news sont digérées et Londres a tranché.</b> À 10h-11h ET, les news EU du matin sont passées, Londres roule depuis 3h et a révélé sa vraie direction (pas le faux mouvement du matin). New York a confirmé. Tu lis une tendance mûre — puis tu attends le Golden Pocket pour entrer.</span></div>
          <div style={{display:"flex", gap:8, padding:"7px 9px", background:"#001018", borderRadius:5}}><span style={{color:"#4ade80", fontWeight:700}}>2.</span><span style={{fontSize:9, color:TEXT, lineHeight:1.45}}><b>La conviction des big boys est confirmée.</b> À 10h-11h, Londres + New York sont tous deux actifs (chevauchement, volume max). Les gros joueurs ont bâti et confirmé leurs positions sur EUR/GBP/CHF. La direction est nette, validée par deux sessions.</span></div>
          <div style={{display:"flex", gap:8, padding:"7px 9px", background:"#001018", borderRadius:5}}><span style={{color:"#4ade80", fontWeight:700}}>3.</span><span style={{fontSize:9, color:TEXT, lineHeight:1.45}}><b>Le mouvement peut durer plusieurs sessions.</b> Une fois entré au Golden Pocket, ta position peut être portée par New York, puis par la session asiatique le soir — chaque paire oppose une devise de Londres à une devise d'Asie, jamais deux de la même session. Tu te places dans un flux qui peut passer de main en main, pas dans un coup d'une heure — mais tu réévalues chaque jour, rien n'est acquis.</span></div>
      ...
      <div style={{padding:"12px 14px", background:"#0a1628", borderRadius:8, border:"1px solid #1e3a5f", marginBottom:14}}>
        ...
        <div style={{fontSize:8.5, color:TEXT_DIM, marginBottom:10}}>L'app vérifie ces 4 filtres OBLIGATOIRES sur tes 7 paires quand tu colles tes données. Une alerte n'apparaît QUE si les 4 sont cochés. Chaque filtre mesure une chose DIFFÉRENTE : où est le capital (Currency Strength), qui est piégé en face (retail), ce que les vraies institutions font (Leveraged Funds), et si le mouvement est réel aujourd'hui (Top Gainers/Losers). Quand les 4 convergent, tu suis les big boys avec le maximum de preuves.</div>
        <div style={{display:"flex", flexDirection:"column", gap:8}}>
          ...
          <div style={{display:"flex", gap:8}}><span style={{color:"#f59e0b", fontWeight:700, minWidth:16}}>④</span><span style={{fontSize:9, color:TEXT, lineHeight:1.5}}><b style={{color:"#f59e0b"}}>MOUVEMENT RÉEL</b> : ta paire doit être dans le Top 5 Gainers (achat) ou Top 5 Losers (vente) de MarketMilk. Un vrai mouvement de prix = volume institutionnel aujourd'hui. Confirme la direction à l'analyse — puis tu attends le Golden Pocket pour entrer.</span></div>
          ...
          <div style={{display:"flex", gap:8}}><span style={{color:"#c084fc", fontWeight:700, minWidth:16}}>▶</span><span style={{fontSize:9, color:TEXT, lineHeight:1.5}}><b style={{color:"#c084fc"}}>ENTRÉE</b> : attends le pullback au <b style={{color:"#c084fc"}}>Golden Pocket (61.8%–65%)</b> sur H1. Le pullback peut arriver pendant Londres, NY ou Tokyo — tu es patient. 2-3 rejets dans la zone puis tu entres. Stop serré, target 1.5-2×. Tu gardes en swing 1 à 3 jours — réévalue chaque matin à 10h30</span></div>
        </div>
        <div style={{fontSize:8, color:TEXT_DIM, marginTop:8}}>⭐ MEILLEURE (surbrillance) : parmi les paires qui passent les 4 filtres, celle qui combine la plus forte divergence ET les Leveraged Funds les plus engagés. C'est le signal le plus net du jour.</div>
      </div>
      ...
      <div style={{padding:"12px 14px", background:"#04140a", borderRadius:8, border:"1px solid #4ade8055", marginBottom:14}}>
        ...
        <div style={{fontSize:8.5, color:TEXT_DIM, marginBottom:10}}>Currency Strength : CHF fort (refuge Europe) vs JPY faible. Pourquoi CHF/JPY ACHAT cochait les 4 filtres APEX — et pourquoi la position a tenu plusieurs jours.</div>
        <div style={{display:"flex", flexDirection:"column", gap:6}}>
        ...
        <div style={{fontSize:9, color:"#4ade80", marginTop:10, padding:"8px 10px", background:"#0a2010", borderRadius:5, lineHeight:1.5, fontWeight:600}}>✅ Les 4 filtres réunis = ALERTE APEX. Tu observes l'impulsion (CHF fort, JPY faible) et tu traces le Fibonacci. Le cycle réel : Londres lance le matin, le pullback arrive au Golden Pocket (61.8%-65%) souvent pendant Tokyo le soir — tu attends 2-3 rejets puis tu entres. Si la divergence persiste, Londres peut reprendre CHF/JPY le lendemain et prolonger le mouvement. La position peut tenir plusieurs jours tant que CHF reste fort et JPY faible — mais tu vérifies chaque matin : si l'écart se referme, tu sors.</div>
      </div>
      ...
      <div style={{padding:"12px 14px", background:"#0a1628", borderRadius:8, border:"1px solid #fbbf2444", marginBottom:14}}>
        ...
        <div style={{display:"flex", flexDirection:"column", gap:8}}>
          {[
            {t:"10h30-10h45 ET", a:"Colle MarketMilk + lance l'analyse", p:"Londres a tranché + NY a confirmé", col:"#4ade80"},
        ...
        <div style={{fontSize:8, color:TEXT_DIM, marginTop:8, lineHeight:1.5}}>Si aucune alerte ne sort à 10h-12h = pas de trade ce jour. La discipline d'attendre le bon setup fait partie de la stratégie.</div>
      </div>
      ...
      <div style={{padding:"12px 14px", background:"#160a2e", borderRadius:8, border:"1px solid #c084fc44", marginBottom:14}}>
        ...
        <div style={{fontSize:8, color:"#c084fc", marginTop:10, padding:"8px 10px", background:"#1a0a2e", borderRadius:6, lineHeight:1.6, fontWeight:600, textAlign:"center"}}>
          La règle d'or : les institutions piègent le matin, révèlent à midi, et relaient le soir. Toi, tu ne joues jamais le piège — tu lis la trace et tu suis le train une fois qu'il roule.
        </div>
      </div>
      ...
      <div style={{padding:"12px 14px", background:"#0a1628", borderRadius:8, border:"1px solid #fbbf2444", marginBottom:14}}>
        ...
        <div style={{display:"flex", flexDirection:"column", gap:10}}>
          ...
          <div style={{padding:"8px 10px", background:"#052010", borderRadius:6, borderLeft:"3px solid #00ff88"}}>
            <div style={{fontSize:9, color:"#00ff88", fontWeight:700, marginBottom:3}}>10h-12h ET — Tu lis leur trace, tu identifies la direction, tu attends le Golden Pocket</div>
          ...
          <div style={{padding:"8px 10px", background:"#001018", borderRadius:6, borderLeft:"3px solid #c084fc"}}>
            ...
            <b style={{color:"#38bdf8"}}>Londres lance à 3h :</b> Deutsche Bank, HSBC, BNP achètent EUR/GBP/CHF (devises de Londres) et vendent AUD/NZD/JPY (devises d'Asie) selon les données économiques européennes. Chaque paire oppose toujours une devise de Londres à une devise d'Asie — jamais deux devises de la même session. La divergence est créée — tu la lis à 10h-11h sur MarketMilk, une fois confirmée.<br/><br/>
          ...
          <div style={{padding:"8px 10px", background:"#1a1500", borderRadius:6, border:"1px solid #fbbf2444"}}>
            ...
            <div style={{fontSize:8, color:TEXT_DIM, lineHeight:1.5}}>Tu ne sais jamais exactement ce que les banques font. Mais MarketMilk + le COT te montrent CE QU'ELLES ONT DÉJÀ FAIT. Tes 3 filtres confirment que le mouvement est réel. Tu ne devines pas — tu confirmes et tu suis. Tu n'es pas la liquidité. Tu suis la liquidité.</div>
          </div>
        </div>
      </div>
