      ...
      <div style={{padding:"12px 14px", background:"#0a1628", borderRadius:8, border:"1px solid #fbbf2444", marginBottom:14}}>
        ...
        <div style={{display:"flex", flexDirection:"column", gap:10}}>
          ...
          <div style={{padding:"8px 10px", background:"#001018", borderRadius:6, borderLeft:"3px solid #c084fc"}}>
            ...
            <b style={{color:"#fbbf24"}}>New York garde à 8h :</b> NY ne trade pas tes paires directement (pas de dollar dans tes 7 paires). Mais le fondamental n'a pas changé — la tendance de Londres tient. Tu gardes ta position.<br/><br/>
