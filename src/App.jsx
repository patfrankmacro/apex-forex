      ...
      <div style={{padding:"12px 14px", background:"#0a1628", borderRadius:8, border:"1px solid #fbbf2444", marginBottom:14}}>
        ...
        <div style={{display:"flex", flexDirection:"column", gap:10}}>
          ...
          <div style={{padding:"8px 10px", background:"#001018", borderRadius:6, borderLeft:"3px solid #c084fc"}}>
            ...
            <b style={{color:"#38bdf8"}}>Londres lance à 3h :</b> Deutsche Bank, HSBC, BNP achètent EUR/GBP/CHF et vendent AUD/NZD/JPY selon les données économiques européennes. La divergence est créée — tu la lis à 6h30 sur MarketMilk.<br/><br/>
            ...
            <b style={{color:"#a78bfa"}}>Tokyo/Sydney reprennent le soir :</b> Les desks de Tokyo voient CHF/JPY en hausse depuis Londres — CHF fort (refuge européen, données solides), JPY faible (BoJ accommodant). Ils continuent à vendre le JPY car rien n'a changé au Japon. Sydney voit AUD/NZD faibles selon les données chinoises et australiennes — ils continuent à vendre. Même fondamental, même direction, nouvelle session.<br/><br/>
