  ...
  return (
    <div style={{maxWidth:520, margin:"0 auto"}}>
      <div style={{textAlign:"center", marginBottom:12}}>
        ...
        <div style={{fontSize:9, color:"#7dd3fc", fontWeight:700}}>LE PÔLE DE LONDRES · DEUX PORTES</div>
        <div style={{fontSize:8, color:TEXT_DIM, marginTop:4, lineHeight:1.5}}>Le pôle de Londres se construit de 3h à 9h30 — c'est le programme des desks, le MÊME chaque jour. Tu as deux façons de le suivre : la CASSURE de 8h (tu montes sur la continuation fraîche, pendant qu'ils chargent — porte A) ou le RETRACEMENT de 9h30 (tu montes dans le creux au rebond Fib sur M5, après leur dernier piège — porte B). Une porte par jour, sortie avant 17h, jamais d'overnight.</div>
      </div>
      ...
      <div style={{padding:"12px 14px", background:"#0d1420", borderRadius:8, border:"1px solid #1e3a5f", marginBottom:14}}>
        ...
        {[
          ...
          {n:"2", icon:"👁️", color:"#38bdf8", t:"7H45 ou 9H — LA TENDANCE DE LONDRES (M15)", sub:"Londres pousse dans UN sens depuis 3h (après le piège) ? La jambe est claire sur ton M15 = le pôle est posé. C'est la matière première des DEUX portes : tu y traceras ton Fibonacci (porte B) ou tu guetteras la cassure de son flag (porte A)."},
          {n:"3", icon:"🥛", color:"#fbbf24", t:"7H45-8H45 ou 9H-9H30 — SCANNE LE CURRENCY STRENGTH", sub:"Colle MarketMilk. Ta paire doit avoir ≥3 rangs d'écart dans le sens du pôle, le sentiment ③ aligné, et PAS dans le Least Volatile (❄️ veto carburant). Pour l'or (XAU) : double convergence obligatoire (USD #1-2 + RISK-ON = vente · USD #7-8 + RISK-OFF = achat). Le scan vaut pour les deux portes."},
          ...
          {n:"5", icon:"🚀", color:"#34d399", t:"ENTRE — CHOISIS TA PORTE", sub:"PORTE A (8h) : le forex NY ouvre, le flag de Londres casse dans le sens du pôle — tu entres sur la clôture M15 confirmée, stop large pour survivre au balayage de 9h30. PORTE B (9h30) : le NYSE retrace, tu traces le Fib sur la jambe et tu entres au rebond (38.2/50/61.8%) sur M5, stop sous le retracement. UNE porte par jour. Target = hauteur du pôle."},
      ...
      <div style={{padding:"12px 14px", background:"#0a1220", borderRadius:8, border:"1px solid #7dd3fc55", marginBottom:14}}>
        ...
        <div style={{fontSize:8.5, color:TEXT, lineHeight:1.7, marginBottom:8}}>{"Pendant que tu dors, les desks de Londres ouvrent à 3h et tendent leur piège (fausse cassure du range asiatique). Puis de 4h à 9h30 ils chargent leur vraie position par tranches — c'est le PÔLE sur ton M15. À 8h le forex NY ouvre et leur flag CASSE (porte A, la continuation fraîche). À 9h30 le NYSE retrace une dernière fois avant de repartir (porte B, le creux). Deux fenêtres pour suivre le même pôle — tu en choisis une."}</div>
        ...
        <div style={{fontSize:8.5, color:TEXT, lineHeight:1.7, marginBottom:8}}><b style={{color:"#fbbf24"}}>{"7h45 ou 9h — Tu vérifies le terrain : le pôle."}</b>{" Ton M15 montre-t-il un flux continu depuis 3h-4h (leur conviction) ? C'est la jambe des deux portes : tu y traceras ton Fib (porte B) ou tu guetteras la cassure de son flag (porte A). Pas de pôle propre = ils hésitent = tu t'abstiens."}</div>
        <div style={{fontSize:8.5, color:TEXT, lineHeight:1.7, marginBottom:8}}><b style={{color:"#fbbf24"}}>{"7h45 ou 9h — Tu choisis le sentiment : ③."}</b>{" Un regard sur le Risk Meter : RISK-ON ou RISK-OFF ? Si tu joues la porte B, les news US de 8h30 sont passées — vérifie qu'elles n'ont pas retourné l'humeur. Un clic, c'est mémorisé."}</div>
        <div style={{fontSize:8.5, color:TEXT, lineHeight:1.7, marginBottom:8}}><b style={{color:"#fbbf24"}}>{"7h45-8h45 ou 9h-9h30 — Tu colles MarketMilk et tu scannes : ①."}</b>{" Le Currency Strength agrège ce que les desks ont FAIT depuis 3h : quelle devise reçoit le capital, laquelle le perd. ≥3 rangs dans le sens du pôle + ③ aligné + pas Least Volatile (❄️) = feu vert. Le scan vaut pour les deux portes."}</div>
        <div style={{fontSize:8.5, color:TEXT, lineHeight:1.7, marginBottom:8}}><b style={{color:"#4ade80"}}>{"8h ou 9h30 — Tu entres, selon ta porte."}</b>{" PORTE A : à 8h le forex NY double la liquidité, le flag de Londres casse dans le sens du pôle — tu entres sur la clôture M15 confirmée, stop large pour survivre au balayage de 9h30. PORTE B : à 9h30 le NYSE retrace, tu entres au rebond Fib (38.2/50/61.8%) sur M5, stop sous le retracement. Target = hauteur du pôle. Tu n'as rien deviné : tu as lu leur trace et tu montes derrière eux."}</div>
        <div style={{fontSize:8.5, color:TEXT, lineHeight:1.7, padding:"8px 10px", background:"#0d1828", borderRadius:5}}>{"⚡ En une phrase : les desks construisent le pôle (3h-9h30), tu lis leur trace (① + ③ au scan), et tu montes derrière eux — soit sur la cassure fraîche de 8h (porte A), soit dans le creux du retracement de 9h30 (porte B). Si un maillon manque — pas de pôle, pas de 3 rangs, sentiment contraire, paire gelée — la chaîne est cassée et tu passes. UNE porte, UNE entrée par jour. La discipline du non-trade EST le système."}</div>
      </div>
      ...
      <div style={{padding:"12px 14px", background:"#0d1420", borderRadius:8, border:"1px solid #1e3a5f", marginBottom:14}}>
        ...
        <div style={{fontSize:8.5, color:TEXT, lineHeight:1.6, marginBottom:10}}>{"La tendance de Londres (3h-9h30) est ta JAMBE commune aux deux portes. PORTE A : à 8h le flag de Londres casse, tu entres sur la clôture M15 dans le sens du pôle (la continuation fraîche). PORTE B : à 9h30 le NYSE fait RETRACER la jambe, tu traces le Fibonacci et tu guettes le rebond — 38.2% = retracement peu profond (tendance forte) · 50% = sain · 61.8% = dernière défense. Au-delà = mort, pas de trade. Le schéma ci-dessous illustre la porte B (le retracement sur M5)."}</div>
        ...
        <div style={{fontSize:8, color:TEXT_DIM, lineHeight:1.5}}>{"\u2460 Pôle : Londres pousse de 3h à 9h30 (ta jambe, sur M15), testée par NY sans s\u0027inverser. \u2192 PORTE A (8h) : le forex NY double la liquidité, le flag casse \u2014 entrée sur la clôture M15, stop derrière le flag. \u2192 PORTE B (9h30) : le NYSE fait retracer vers un niveau Fib (38.2/50/61.8% sur M5), entrée au rebond, stop sous le 61.8%. Les deux : target = hauteur du pôle, sortie avant 17h. Miroir baissier identique, inversé."}</div>
      </div>
      ...
      <div style={{padding:"12px 14px", background:"#0d1420", borderRadius:8, border:"1px solid #1e3a5f", marginBottom:14}}>
        ...
        {[
          ...
          {h:"8h", t:"Forex NY ouvre — PORTE A (cassure)", d:"La liquidité double. Si les desks ont une conviction, leur flag casse dans le sens du pôle = la continuation fraîche de leur tendance du matin.", n:"Entrée porte A : clôture M15 hors du flag. Stop large — le balayage de 9h30 viendra APRÈS toi."},
          ...
          {h:"9h30", t:"Le NYSE ouvre — PORTE B (retracement Fib)", d:"Le NYSE injecte son volume et tire le prix CONTRE la tendance de Londres : il ramasse la liquidité avant de repartir. C'est ton point d'entrée, pas un danger.", n:"Entrée porte B : rebond sur un niveau Fib (38.2/50/61.8%) sur M5, dans le sens du pôle. Au-delà du 61.8% = setup mort."},
        ...
        <div style={{fontSize:8, color:"#4ade80", marginTop:6, padding:"7px 9px", background:"#052010", borderRadius:5, lineHeight:1.5, fontWeight:600}}>La règle d'or intraday : Londres construit la tendance (3h-9h30). Tu montes derrière les desks par UNE des deux portes — la cassure du flag à 8h (porte A, continuation) ou le rebond du retracement Fib à 9h30 (porte B). Tu sors avant 17h. Une seule porte, une seule entrée, zéro overnight.</div>
      </div>
